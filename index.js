...
const inyandikoRoutes = require('./routes/inyandiko');
...
app.use('/api/classes', lessonRoutes);
...
app.use('/api/student/quiz-reports', require('./routes/student_quiz_reports'));
app.use('/api/classes', leaderboardRoutes);
app.use('/api/classes', inyandikoRoutes);

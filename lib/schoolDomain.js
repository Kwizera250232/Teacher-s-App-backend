...
/** Domain for new staff accounts before they join a school (override via STAFF_SIGNUP_EMAIL_DOMAIN). */
function getStaffSignupEmailDomain() {
  const d = String(process.env.STAFF_SIGNUP_EMAIL_DOMAIN || 'staff.umunsi.edu').trim().toLowerCase();
  return d.includes('.') ? d : 'staff.umunsi.edu';
}

...
echo "==> Group work my-groups (want 401, not 404):"
curl -s -o /dev/null -w "HTTP %{http_code}\n" "http://127.0.0.1:${PORT}/api/classes/1/my-groups"
echo ""
echo "==> Public health:"
...
curl -s -o /dev/null -w "Public my-groups: HTTP %{http_code}\n" "https://studentapi.umunsi.com/api/classes/1/my-groups"
echo ""
